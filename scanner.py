...
class MultiArchetypeTradingScanner:
    ...
    def get_csrf_token(self):
        """Get CSRF token and establish session with Chartink"""
        try:
            # Use a known working screener URL to get the token
            screener_url = 'https://chartink.com/screener/time-pass-48'
            print(f"🔗 Getting CSRF token from {screener_url}")
    ...
    def execute_chartink_query(self, query, max_retries=2):
        """Execute stock screening query on Chartink with proper CSRF handling"""
...
<body>
    <div class="container">
        ...
        <div class="api-status">
            ✅ <strong>System Status:</strong> Chartink integration updated with CSRF token handling for improved reliability
        </div>
        ...
        <div class="footer">
            <p><strong>📈 Multi-Archetype Trading Scanner v2.0</strong></p>
            <p>Total Opportunities: {total_stocks} | Strategies: {len(results)} | Next Scan: Tomorrow 10:00 AM IST</p>
            <p>Based on Three Foundational Trading Archetypes | Enhanced CSRF Handling</p>
        </div>
    </div>
</body>
</html>'''
    ...
    def run_scan(self):
        ...
        print("🔧 Enhanced with CSRF token handling for Chartink reliability")
        print("=" * 60)
